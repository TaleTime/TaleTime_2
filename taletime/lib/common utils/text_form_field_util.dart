...
class TextFormFieldUtil {
  ...
  TextFormField enterUserNameForm(BuildContext context, TextEditingController nameController) {
    return TextFormField(
        controller: nameController,
        decoration: Decorations().textInputDecoration(AppLocalizations.of(context)!.username,
            AppLocalizations.of(context)!.enterUsername, const Icon(Icons.person)),
  ...
  TextFormField enterEmailForm(BuildContext context, TextEditingController emailController) {
    return TextFormField(
  ...
  TextFormField enterOldPasswordForm(
    ...
    return TextFormField(
        ...
        autovalidateMode: AutovalidateMode.onUserInteraction,
        validator: (password) => ValidationUtil().validatePassword(password, context));
  }

  /// TextFormField to enter a password
  ///
  /// [passwordController] --> catches the user input for the password
  TextFormField enterPasswordForm(BuildContext context, TextEditingController passwordController) {
    return TextFormField(
  ...
  TextFormField confirmPasswordForm(BuildContext context, TextEditingController passwordController,
      TextEditingController confirmPasswordController) {
    return TextFormField(
        controller: confirmPasswordController,
        obscureText: true,
        decoration: Decorations().textInputDecoration(AppLocalizations.of(context)!.confirmPassword,
            AppLocalizations.of(context)!.confirmYourPassword, const Icon(Icons.lock)),
        autovalidateMode: AutovalidateMode.onUserInteraction,
        validator: (password) {
