...
class SpeakerHomePage extends StatefulWidget {
  ...
  final profiles;
  const SpeakerHomePage(this.profile, this.profiles, this.storiesCollection, this.lastRecordedCollection,{Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _SpeakerHomePageState(this.profile, this.profiles, this.storiesCollection, this.lastRecordedCollection);
  }
}
...
class _SpeakerHomePageState extends State<SpeakerHomePage> {
  ...
  _SpeakerHomePageState(this.profile, this.profiles, this.storiesCollection, this.lastRecordedCollection);
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => SpeakerHomePage(profile, profiles, storiesCollection, lastRecordedCollection)));
                            },
                            child: ListTile(
                              title: Text(
                                resultTitle,
                      ...
                      children: [
                        Container(
                          ...
                          child: storiesDocumentSnapshot.length == 0
                              ...
                              "No stories yet. \nplease add some stories to your story library",
                              "")
                              : ListViewStoryTeller(storiesDocumentSnapshot, storiesCollection, profile, profiles),
                        ),
                      ],
                    ),
                  ),
