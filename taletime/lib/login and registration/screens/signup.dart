  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Decorations().appBarDecoration(
          title: AppLocalizations.of(context)!.register, context: context, automaticArrow: true),
                      ...
                      Form(
                          ...
                          child: Column(children: <Widget>[
                            ...
                            Container(
                                decoration: Decorations().inputBoxDecorationShaddow(),
                                child:
                                    TextFormFieldUtil().enterEmailForm(context, _emailController)),
                            const SizedBox(height: 20),
                            Container(
                  ...
                  child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (isValidForm) {
                            AuthentificationUtil(auth: auth).registerWithEmailAndPassword(
                                userName: userName,
                                email: email,
                                password: password,
                                context: context);
