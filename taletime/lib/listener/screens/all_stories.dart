...
class AllStories extends StatefulWidget {
  ...
  final profile;
  final profiles;
  const AllStories(this.profile, this.profiles, this.recordedStoriesCollection, {Key? key}) : super(key: key);

  @override
  State<AllStories> createState() => _AllStoriesState(this.profile, this.profiles, this.recordedStoriesCollection);
}
                        ...
                        children: [
                          Container(
                            ...
                            child: recordedStoriesDocumentSnapshot.length == 0
                                ...
                                "")
                                : ListViewStoryTeller(recordedStoriesDocumentSnapshot, recordedStoriesCollection, profile, profiles),
                          ),
                        ],
                      ),
                    ),
