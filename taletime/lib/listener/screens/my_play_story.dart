            ...
            Positioned(
              ...
              child: AppBar(
                ...
                actions: <Widget>[
                  IconButton(
                    onPressed: (){},
                    icon: story["isLiked"] ? Icon(Icons.favorite, color: Colors.teal.shade600,) : Icon(Icons.favorite_border_sharp, color: Colors.teal.shade600,),
                  ),
                  IconButton(
                    onPressed: (){},
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Image.network(story["image"] == "" ? storyImagePlaceholder : story["image"]),
                    ),
                  ],
                ),
              ),
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              icon: Icon(Icons.skip_previous, size: 30, color: kPrimaryColor,),
                              onPressed: () {
                              },
                            ),
                            IconButton(
                              padding: const EdgeInsets.only(bottom: 10),
                              icon: isPlaying == false ? Icon(Icons.play_circle_fill, color: kPrimaryColor,size: 50,)
                                  : Icon(Icons.pause_circle_filled, color: kPrimaryColor,size: 50,),
                              onPressed: () async {
                                if(isPlaying){
                                  await player.pause();
                                  setState(() {
                            ...
                            IconButton(
                              padding: const EdgeInsets.only(top: 4),
                              icon: Icon(Icons.skip_next, size: 30, color: kPrimaryColor,),
                              onPressed: () {
                              },
                            ),
                          ],
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            icon: Icon(Icons.replay_10, size: 22, color: kPrimaryColor,),
                            onPressed: () {
                            },
                          ),
                          IconButton(
                            icon: Icon(Icons.queue_music_outlined, size: 22, color: kPrimaryColor,), onPressed: () {  },
                          ),
                          IconButton(
                            icon: Icon(Icons.share_outlined, size: 22, color: kPrimaryColor,), onPressed: () {  },
                          ),
                          IconButton(
                            padding: const EdgeInsets.only(top: 7),
                            icon: Icon(Icons.forward_10, size: 22, color: kPrimaryColor,),
                            onPressed: () {
                            },
                          ),
                        ],
