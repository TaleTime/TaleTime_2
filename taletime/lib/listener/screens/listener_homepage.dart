                    ...
                    IconButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => SettingsPage(profile, profiles)));
                      },
                      icon: Icon(Icons.menu, size: 33, color: kPrimaryColor //kPrimaryColor
                          ),
                    )
                  ],
                ),
                        ...
                        onChanged: (value) {
                          setState(() {
                            matchStoryList = SearchBarUtil()
                                .searchStory(storiesDocumentSnapshot, value); //search stories
                          });
